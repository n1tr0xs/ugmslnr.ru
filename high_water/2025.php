...
<body>
  ...
  <div id='containter'>
    <div id='content'>
      ...
      <div>
        <a href="preliminary-assessment.php"> Предварительная оценка развития весеннего половодья на реках
          Луганской Народной Республики в 2025 году </a>
      </div>

      <div>
        <a href="consultation.php"> Консультация об ожидаемых максимальных уровнях воды весеннего половодья на
          реках Луганской Народной Республики в 2025 году </a>
      </div>

      <!-- Текущее состояние -->
      <? if (file_exists($_SERVER['DOCUMENT_ROOT'] . "/updatable/high_water/weekly.pdf")) { ?>
        <a href="/updatable/high_water/weekly.pdf" target="_blank"> Еженедельный прогноз гидрологической обстановки
        </a>
      <? } ?>
          ...
          <? foreach ($rows as $row) { ?>
            <tr>
              <? if ($is_first) { ?>
                ...
                ?>
                <td rowspan="10" style="vertical-align: middle; background-color: <?= $max_color; ?>"> Луганская
                  Народная Республика </td>
                <? $is_first = false;
              } ?>
              <?
