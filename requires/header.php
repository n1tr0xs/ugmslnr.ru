...
<? if(date("Y") == "2024") { ?>
 ...
 <a href="#" style="background-image:url(/files/imgs/banner80letwowback.png); background-position: center; background-size:cover;display:flex;justify-content:center;width:100%;overflow:hidden;align-items:center; padding: 0">
      <img src="/files/imgs/banner80letwowfront.png" style="max-height: 60px; max-width:100%; object-fit:contain;" alt=""> 
    </a>
 <? } ?>
  <div>
    <img src="/files/imgs/logo.png?v=2" alt="Логотип Росгидромет" style="width: 80px; height: 80px; margin-left: 25px; float: left">
    <p style="font-size: 1.2em; padding: .5em;"> ФЕДЕРАЛЬНОЕ ГОСУДАРСТВЕННОЕ БЮДЖЕТНОЕ УЧРЕЖДЕНИЕ </p>
    <p style="font-size: 1.2em; padding: .5em;"> «Управление по гидрометеорологии и мониторингу окружающей среды по Луганской Народной Республике» </p>
  </div>
</header>
