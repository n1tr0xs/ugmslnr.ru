...
<? $PAGE_NAME = "Администрирование - загрузка гидрометеорологического бюллетеня"; ?>
        ...
        <div id='content'>
            ...
            <form action="exec.php" method="post" enctype="multipart/form-data">
                <fieldset>
                    ...
                    <label for="replace_statement">Заменить предыдущий отчет</label>
                    <input type="checkbox" name="replace_statement" id="replace_statement" />
