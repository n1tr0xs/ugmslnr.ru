...
<body>
  ...
  <div id='containter'>
    <div id='content'>
      ...
      <p>27 сентября, в целях обеспечения экологически благоприятной среды для проживания населения на территории
        ЛНР, коллектив ФГБУ «УГМС по ЛНР» принял активное участие во Всероссийском субботнике «Зеленая Россия».
        Проведена работа по наведению порядка на прилегающей территории в соответствии с нормами
        благоустройства. </p>
      ...
      <p>Прекрасная погода и сплоченные действия коллектива учреждения позволили справиться с большим объемом
        работы быстро и качественно! Слаженная работа помогла навести чистоту и порядок!</p>
