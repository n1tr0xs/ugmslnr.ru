  ...
  <div id='containter'>
    <div id='content'>
      ...
      <div class='text-center'>
        ...
        <p>Если обнаружены несовпадения, то, вероятно, документ подделан. В этом случае немедленно обратитесь в ФГБУ "УГМС по ЛНР" для уточнения информации!</p>
        <p style="color: red;">Обращаем внимание, что использование заведомо подложных документов является уголовно наказуемым преступлением!</p>
    </div>
